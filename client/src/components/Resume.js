...
const Resume = props => {
  return (
    <div className="small-12 small-centered columns">
      ...
      <div id="resume-links">
        <div className="small-3 columns skills-link">
          <h3>
            <a href="#skills">Skills</a>
          </h3>
        </div>
        <div className="small-3 columns education-link">
          <h3>
            <a href="#education">Education</a>
          </h3>
        </div>
        <div className="small-3 columns past-work">
          <h3>
            <a href="#past-work">Past Work</a>
          </h3>
        </div>
        <div className="small-3 columns volunteer-work">
          <h3>
